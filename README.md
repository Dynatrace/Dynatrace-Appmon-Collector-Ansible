...
| *dynatrace_collector_linux_installer_file_name* | dynatrace-collector-7.1.0.1803-linux-x86.jar                             | The file name of the Dynatrace Collector installer in the role's ```files``` directory. |
| *dynatrace_collector_linux_installer_file_url*  | https://files.dynatrace.com/downloads/OnPrem/dynaTrace/7.1/7.1.0.1803/dynatrace-collector-7.1.0.1803-linux-x86.jar | A HTTP, HTTPS or FTP URL to the Dynatrace Collector installer in the form (http\|https\|ftp)://[user[:pass]]@host.domain[:port]/path. |
